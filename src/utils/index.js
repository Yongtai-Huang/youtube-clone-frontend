...
export const upload = async (resourceType, file) => {
  ...
  formData.append("upload_preset", "youtubeclone"); // hyt: ??
  ...
  const result = {
    url: `${process.env.REACT_APP_VIDEO_ENDPOINT}/${data.filename}`,
    thumbnailUrl: `${process.env.REACT_APP_VIDEO_ENDPOINT}/${data.thumbnail}`,
